# Datos de reciento electoral obtenidos de:
# http://portal.cne.gob.ec/images/d/2021/Distributivo_recintos_e/Distributivo_de_recintos_final_2021.xls

# Junta: Unidad Educativa Técnico Salesiano
# Número de electores en la junta: 7000

# ----- CONSIDERACIONES -----
#   - 80% de la poblacion se vacunara dentro del pais
#   - 5% al 10% no podrán vacunarse
#   - La segunda dosis se realiza despues de 30 dias
#   - Las personas tienen un solo recinto para vacunarse
...
# ----- RESULTADOS -----
# Para esta simulacion se desea conocer:
#   - Total de personas que realizaron el proceso de vacunacion
